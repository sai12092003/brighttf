...
<header class="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-brand-neutral-200/70">
    <div class="container-custom flex items-center justify-between py-3">
        <a href="<?= base_url('/') ?>" class="flex items-center gap-3 shrink-0">
            <img src="<?= asset('img/logo-color-160.png') ?>" alt="Bright Today Foundation" class="h-11 w-11 sm:h-12 sm:w-12">
            <span class="hidden sm:flex flex-col leading-tight">
                <span class="font-display font-semibold text-brand-blue-900 text-lg">Bright Today</span>
                <span class="text-[11px] tracking-widest uppercase text-brand-orange-600 font-semibold -mt-0.5">Foundation</span>
            </span>
        </a>
